...
│  • Create new tenants/user accounts                                         │
...
└────────────────┬────────────────────────────────────────────────────────────┘
        ...
        └────┬────────┬───┘
             │        │
  ┌──────────▼───┐ ┌──▼──────────────┐
  │ RECURRING    │ │ ACCUMULATE &    │
  │ INVOICES     │ │ INVOICE         │
  └──────────────┘ └──────────────────┘
        │                    │
        │                    ├─► Log Timesheets (all month)
        ├─► Create Items     │
        │                    ├─► Add Ad-Hoc Items
        ├─► Set Policy       │
        │   (Run Day)        ▼
...
See the full visual flowchart on our [GitHub documentation](https://github.com/peterretief/billing-v2) for an interactive version.
