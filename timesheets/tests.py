...
class TimesheetCategoryTests(BaseBillingTest):
    ...
    def setUp(self):
        ...
        self.category_dev = WorkCategory.objects.create(
            user=self.user,
            name="Development"
        )
        self.category_design = WorkCategory.objects.create(
            user=self.user,
            name="Design"
        )
...
class GenerateInvoiceBulkTests(BaseBillingTest):
    ...
    def setUp(self):
        ...
        self.category_meetings = WorkCategory.objects.create(
            user=self.user,
            name="Meetings"
        )
    ...
    def test_generate_invoice_uses_category_name(self):
        ...
        for desc, rate, total_h in [("Development", Decimal('150.00'), Decimal('8.00')), 
